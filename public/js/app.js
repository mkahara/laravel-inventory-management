...
$(document).ready(function () {
  ...
  function updateTable(products) {
    ...
    $.each(products, function (index, product) {
      var row = '<tr>' + '<td class="product-name">' + product.product_name + '</td>' + '<td class="quantity">' + product.quantity + '</td>' + '<td class="price">' + formatAmount(product.price) + '</td>' + '<td>' + product.date_submitted + '</td>' + '<td>' + formatAmount(product.price * product.quantity) + '</td>' + '<td><button type="button" class="btn btn-success btn-sm edit-btn mx-2" data-index="' + product.id + '">Edit</button>' + '<button type="button" class="btn btn-danger btn-sm delete-btn" data-index="' + product.id + '">Delete</button></td>' + '</tr>';
  ...
  $(document).on("click", ".edit-btn", function () {
    var productNameTd = $(this).closest("tr").find(".product-name");
    var quantityTd = $(this).closest("tr").find(".quantity");
    var priceTd = $(this).closest("tr").find(".price");
